...
import { Check, Pie, Bag, Card, Clock, Frown ,payment} from './Icons'
...
const Dashboard = () => {
    ...
    // navigate  path
    const PartialPaidInvoices="/PartialPaidInvoices";
    const unpaidpath="/unpaid";
    const paidpath="/paid";
    const extrapaidpath="/Extrapayment";
        ...
        <div className={styles.pageContainer}>
            ...
            <ul className={styles.autoGrid}>
                        ...
                        <li className={styles.listItem} >
                         ...
                         <li className={styles.listItem}  onClick={()=>{navigate("/invoices")}} >
                            <div>
                        ...
                        <li className={styles.listItem} style={{backgroundColor: '#206841', color: 'white'}}  onClick={()=>{navigate(paidpath)}}  >
                            <div>
                                <p>{paid.length}</p>
                        ...
                        <li className={styles.listItem}  onClick={()=>{navigate(PartialPaidInvoices)}} >
                            <div>
                                <p>{partial.length}</p>
                        ...
                        <li className={styles.listItem} onClick={()=>{navigate(unpaidpath)}}  >
                            <div>
                        ...
                        <li className={styles.listItem} onClick={()=>{navigate(extrapaidpath)}}  >
                            <div>
                                <p>{Extrapayment.length}</p>
                                <h2>Extrapayment Invoices</h2>
                            </div>
                            <div>
