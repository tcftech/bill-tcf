...
//import dummyimg from 'C:/Users/Lenovo/Downloads/vicky/accountill-master/accountill-master/client/public/logo192.png';
    ...
    {switchEdit === 1 && (
      ...
      <div style={{display: 'flex', 
        ...
        paddingBottom: '20px'
          ...
          {/* log temporily stop it vicky */}
        {/* <Avatar style={{width: '100px', height: '100px'}} src={'https://postimg.cc/8Fv2xjk3'} alt="" className={classes.avatar} /> */}
      </div>
